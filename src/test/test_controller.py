...
class TestController(TestCase):
    ...
    def test_process_fileHuman(self):
        ...
        with open("src/test/data/human_generated_text.txt", 'rb') as t:
            ...
            self.assertEquals("The Text was written by Human.", control.process_text(c.parse_file(file))["Model Output"])
    ...
    def test_process_fileAI(self):
        ...
        with open("src/test/data/chat-gpt_generated_text.txt", 'rb') as t:
            ...
            self.assertEquals("The Text was generated by AI.", control.process_text(c.parse_file(file))["Model Output"])
